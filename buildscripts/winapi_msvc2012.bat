...
mkdir %V_BUILDDIR%
cd %V_BUILDDIR%
cl /c /nologo /Ox /EHsc /W3 /MT /D_CRT_SECURE_NO_WARNINGS /DUNICODE /D_UNICODE /DIDI_ICON1=42 /DPSAPI_VERSION=1 /DNDEBUG /arch:IA32 ..\src_winapi\main.cpp /Fomain.cpp.obj
@if not exist "main.cpp.obj" goto err
cl /c /nologo /Ox /EHsc /W3 /MT /D_CRT_SECURE_NO_WARNINGS /DUNICODE /D_UNICODE /DIDI_ICON1=42 /DPSAPI_VERSION=1 /DNDEBUG /arch:IA32 ..\src_winapi\paintwidget.cpp /Fopaintwidget.cpp.obj
