...
cl /c /nologo /Ox /EHsc /W3 /MT /DUNICODE /D_UNICODE /DIDI_ICON1=42 /DPSAPI_VERSION=1 /DNDEBUG /arch:IA32 ..\src_winapi\main.cpp /Fo:main.cpp.obj
@if not exist "main.cpp.obj" goto err
cl /c /nologo /Ox /EHsc /W3 /MT /DUNICODE /D_UNICODE /DIDI_ICON1=42 /DPSAPI_VERSION=1 /DNDEBUG /arch:IA32 ..\src_winapi\paintwidget.cpp /Fo:paintwidget.cpp.obj
