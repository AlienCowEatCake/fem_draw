...
set V_BUILDDIR=build_winapi_mingw4.8.1_unicode
set MINGW-CXX=g++
...
%MINGW-CXX% -c -O3 -DNDEBUG -DUNICODE -D_UNICODE -Wall -Wextra -Wno-write-strings ../src_winapi/main.cpp -o main.cpp.o
@if not exist "main.cpp.o" goto err
%MINGW-CXX% -c -O3 -DNDEBUG -DUNICODE -D_UNICODE -Wall -Wextra -Wno-write-strings ../src_winapi/paintwidget.cpp -o paintwidget.cpp.o
...
%MINGW-CXX% -O3 -Wall -Wextra main.cpp.o paintwidget.cpp.o resources.rc.o lodepng.cpp.o jo_jpeg.cpp.o jo_gif.cpp.o jo_tga.cpp.o -lgdi32 -lcomctl32 -luser32 -lcomdlg32 -mwindows -static -static-libgcc -static-libstdc++ -o %V_PROJECT%.exe
