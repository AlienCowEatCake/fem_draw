...
cl -c -nologo -G5 -Ox -W3 -MT -TP -DNDEBUG ..\src_winapi\libs\jo_jpeg.cpp -Fojo_jpeg.cpp.obj
@if not exist "jo_jpeg.cpp.obj" goto err
cl -c -nologo -G5 -Ox -W3 -MT -TP -DNDEBUG ..\src_winapi\libs\jo_gif.cpp -Fojo_gif.cpp.obj
@if not exist "jo_gif.cpp.obj" goto err
cl -c -nologo -G5 -Ox -W3 -MT -TP -DNDEBUG ..\src_winapi\libs\jo_tga.cpp -Fojo_tga.cpp.obj
