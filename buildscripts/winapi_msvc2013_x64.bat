...
@echo on
call "%PROGRAMFILES%\Microsoft Visual Studio 12.0\VC\vcvarsall.bat" amd64
...
link /NOLOGO /SUBSYSTEM:WINDOWS,5.02 main.cpp.obj paintwidget.cpp.obj resources.res lodepng.cpp.obj jo_jpeg.cpp.obj jo_gif.cpp.obj jo_tga.cpp.obj gdi32.lib comctl32.lib user32.lib comdlg32.lib /OUT:%V_PROJECT%.exe
